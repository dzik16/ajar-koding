...
const ChatGroup: FC = () => {
  return (
    <div className='d-flex flex-column flex-lg-row shadow-sm rounded'>
      <div className='flex-column flex-lg-row-auto w-100 w-lg-400px w-xl-400px mb-10 mb-lg-0'>
        <div className='card card-flush'>
          <div className='card-header pt-8' id='kt_chat_contacts_header'>
            <span className='fs-3 fw-bolder text-gray-900 mb-2'>
              Anggota Kelompok 1
            </span>
          </div>
